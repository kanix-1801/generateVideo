        ...
        <>
            <div className="content-container">
                <div className="toggle-container">
                    <button
                        ...
                        style={{
                            ...
                            border: activeToggle === 'docs' ? '1px solid #315EFF' : '1px solid #E2E2E2',
                        }}
                    >
                    ...
                    <button
                        ...
                        style={{
                            backgroundColor: activeToggle === 'script' ? '#000927' : '#000927',
                            color: activeToggle === 'script' ? '#315EFF' : '#E2E2E2',
                            border: activeToggle === 'script' ? '1px solid #315EFF' : '1px solid #E2E2E2',
                        }}
                    >
                ...
                <div className='input-containers'>
                    {activeToggle === 'docs' ? (
                        <div>
                            <h1 className='input-containers-heading'>Upload Documents & Images For Generate Script</h1>
                            <div className='upload-sections'>
                                ...
                                >
                                    ...
                                    {/* </span> */}
                                    <label
                                        htmlFor="upload-doc" className="upload-label">
                                        {files.length > 0
                            ...
                            />
                            <button className="generate-button" onClick={handleScriptGenerate}>
                                Generate Script
                            </button>
                        </div>
                    ) : (
